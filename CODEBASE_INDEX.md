...
| ৭ | **অ্যাপস স্ক্রিপ্ট লাইভ ডিপ্লয়মেন্ট** | সংস্করণ @85 লাইভ ওয়েব অ্যাপ ইউআরএলে সফলভাবে ডিপ্লয় করা হয়েছে। | **সম্পন্ন ও ডিপ্লয়ড** |
| ৮ | **টেস্ট স্যুট ভেরিফিকেশন** | test_pages.js (243 tests), test_committee.js (318 tests), test_admin.js (226 tests) মোট ৭৮৭টি টেস্ট পাস করেছে। | **সম্পন্ন ও ডিপ্লয়ড** |
| ৯ | **অ্যাডমিন ব্যাচ অপারেশন ও গ্লাস থিম** | Select All চেকবক্স, ব্যাচ অ্যাপ্রুভ/রিজেক্ট/মার্জ টুলবার ও মডার্ন ব্লারি গ্লাস কার্ড যোগ করা হয়েছে। | **সম্পন্ন ও ডিপ্লয়ড** |
| ১০ | **PDACC কমিটি ও পদবি অটো-ডিটেকশন** | কোচিং সেন্টার (Prokoushali DUET Admission Coaching Centre) বা Director পদবি স্বয়ংক্রিয়ভাবে PDACC হিসেবে চিহ্নিত ও সিঙ্ক হয়। | **সম্পন্ন ও ডিপ্লয়ড** |
| ১১ | **আনক্লেমড প্রোফাইল কন্টাক্ট অ্যাক্সেস** | অ্যাডমিন লগইন থাকলে আনক্লেমড প্রোফাইলের কন্টাক্ট কার্ড আর লক থাকে না; মোবাইল ও ইমেইল নম্বর সরাসরি প্রদর্শিত হয়। | **সম্পন্ন ও ডিপ্লয়ড** |
